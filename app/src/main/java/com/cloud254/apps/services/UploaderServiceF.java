...
public class UploaderServiceF extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
            contentIntent = PendingIntent.getBroadcast(this, 0, new Intent("myFilter"), PendingIntent.FLAG_MUTABLE);
        } else {
            contentIntent = PendingIntent.getBroadcast(this, 0, new Intent("myFilter"), PendingIntent.FLAG_UPDATE_CURRENT);
        }

        Notification notification = new NotificationCompat.Builder(this, Consts.NOTIFICATION_CHANNEL_ID)
                .setSmallIcon(R.drawable.ic_cloudapp)
                .setContentText("Sending backup")
                .addAction(R.drawable.ic_cloudapp, "Stop", contentIntent)
                .build();
